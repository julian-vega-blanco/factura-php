          ...
          <div class="modal-body" style="background-color: rgb(231, 253, 246);">
            ...
            <form class="col d-flex flex-wrap" action="registrarFactura.php" method="post">
              ...
              <div class="mb-1 col-12">
                ...
                <select type="text" id="clienteId" name="clienteId" class="form-control">
                  <option value="nothing"></option>
                    <?php                  
                        foreach ($empleado as $key => $valueEm){
                    ?>
                
                   <option value="<?= $valueEm['clientes_id']?>"><?= $valueEm['nombre']?></option>
